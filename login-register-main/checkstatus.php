...
<div class="col-sm-6 mt-5  mx-3">
  ...
  <h3 class="text-center mt-5">Assigned vaccine Details</h3>
  <table class="table table-bordered">
    <tbody>
      ...
      <tr>
        <td>Father's Name</td>
        <td>
          <?php if(isset($row['fname'])) {echo $row['fname']; } ?>
        </td>
      </tr>
      <tr>
        <td>Email</td>
      ...
      <tr>
        <td>idCard</td>
        <td>
          <?php if(isset($row['idCard'])) {echo $row['idCard']; } ?>
        </td>
      </tr>
      <tr>
        <td>Address</td>
  ...
  <div class="text-center">
    ...
    <form class="d-print-none d-inline" action="admin/request.php"><input class="btn btn-secondary" type="submit" value="Close"></form>
  </div>
  <?php } else {
