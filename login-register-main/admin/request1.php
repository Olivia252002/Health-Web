...
<div class="col-sm-4 mb-5">
  ...
  <?php 
 $sql = "SELECT id, name, phone, email  FROM app";
 ...
 if($result->num_rows > 0){
  while($row = $result->fetch_assoc()){
   ...
   echo '<p class="card-text">Request Phone Number: ' . $row['phone'] . '</p>';
...
if(isset($_REQUEST['close'])){
  $sql = "DELETE FROM app WHERE id = {$_REQUEST['id']}";
